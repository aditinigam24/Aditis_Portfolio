            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="rounded-full border border-border bg-white/[0.03] px-3 py-1 text-[10px] uppercase tracking-wider text-muted-foreground">
                    {p.tag}
                  </span>
                </div>
                ...
                <div className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-secondary transition group-hover:gap-3">
                  Case study
